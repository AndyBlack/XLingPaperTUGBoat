...
\usepackage{hyperref}
\TeXXeTstate=1
\hypersetup{colorlinks=true, citecolor=black, filecolor=black, linkcolor=black, urlcolor=blue, bookmarksopen=true, pdfauthor={Sharron Correl, Hugh Paterson III}, pdfcreator={XLingPaper version 3.10.0 (https://software.sil.org/xlingpaper/)}, pdftitle={XLingPaper Graphite Example}}
\pagestyle{fancy}
\fancyhf{}
...
\newfontfamily{\LanglAwamiFontFamily}[Renderer=Graphite]{Awami Nastaliq}
\newfontfamily{\LanglAwamiNoGraphiteFontFamily}{Awami Nastaliq}
\newfontfamily{\LanglUrduFontFamily}{Urdu Typesetting}
...
\newcommand{\XLingPaperdottedtocline}[4]{\vspace*{-
\baselineskip}
\newdimen\XLingPapertempdim
\vskip0pt plus .2pt{
...
\penalty-3000{{\centering\raisebox{\baselineskip}[0pt]{\protect\hypertarget{sAwami}{}}\SectionLevelOneFontFamily{\large{\raisebox{\baselineskip}[0pt]{\pdfbookmark[1]{2 Awami}{sAwami}}\textbf{2 Awami}}}\\{}}\markright{Awami}
}\par{}\penalty10000
\vspace{12pt}
\indent Renders well (using graphite)\par{}\indent {\LanglAwamiFontFamily{{\fontsize{15}{18}\selectfont  دی بچیاں ٻال آپڻے تے آپڻی کوں شخص ہر}}}\par{}\indent  \par{}\indent Renders poorly (no graphite)\par{}\indent  \par{}\indent {\LanglAwamiNoGraphiteFontFamily{{\fontsize{15}{18}\selectfont  دی بچیاں ٻال آپڻے تے آپڻی کوں شخص ہر}}}\par{}
\vspace{12pt}
\XLingPaperneedspace{5\baselineskip}

\penalty-3000{{\centering\raisebox{\baselineskip}[0pt]{\protect\hypertarget{s2}{}}\SectionLevelOneFontFamily{\large{\raisebox{\baselineskip}[0pt]{\pdfbookmark[1]{3 Awami}{s2}}\textbf{3 Awami}}}\\{}}\markright{Awami}
}\par{}\penalty10000
\vspace{12pt}
\indent {\LanglAwamiFontFamily{{\fontsize{15}{18}\selectfont ۔ ہے حاصل حق دا بچئو نڄے، و چھٹ رزگار وچ جنہاں خلاف دے حالات ڄئے ایہو باہر کنوں وس ٻڈھیپایا رنڈیپا، معزوری، بیماری، رزگاری، بے اتے ہن دیاں چاہی ملڻیاں لتاں سہو ڋوجہبیاں دیاں سیب و اتے معالجے علاج رہائش لباس، خوراک، اوکوں ۔ ہے حاصل حق دا زندگی چنگی کیتے بھلائی تے صحت دی بچیاں ٻال آپڻے تے آپڻی کوں شخص ہر}}}\par{}
\vspace{12pt}
\XLingPaperneedspace{5\baselineskip}
...
\vspace{12pt}
\indent ہ{\LanglUrduFontFamily{{\fontsize{15}{18}\selectfont ۔ ہے حاصل حق دا بچئو نڄے، و چھٹ رزگار وچ جنہاں خلاف دے حالات ڄئے ایہو باہر کنوں وس ٻڈھیپایا رنڈیپا، معزوری، بیماری، رزگاری، بے اتے ہن دیاں چاہی ملڻیاں لتاں سہو ڋوجہبیاں دیاں سیب و اتے معالجے علاج رہائش لباس، خوراک، اوکوں ۔ ہے حاصل حق دا زندگی چنگی کیتے بھلائی تے صحت دی بچیاں ٻال آپڻے تے آپڻی کوں شخص ر}}}\par{}\end{MainFont}
\end{document}
